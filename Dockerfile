...
WORKDIR /src
COPY ["SubscriptionManagement.API/SubscriptionManagement.API.csproj", "SubscriptionManagement.API/"]
RUN dotnet restore "SubscriptionManagement.API/SubscriptionManagement.API.csproj"
COPY . .
WORKDIR "/src/SubscriptionManagement.API"
